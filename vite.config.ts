  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "XWorld"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "XWorld"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/xworld\.app\/"/, `"url": "${activeMeta.url}"`)
  ...
  async function buildRouter() {
    const [
      ...
      resilienceServerMod, resilienceHandlerMod,
        ...
        import('./src/generated/server/xworld/seismology/v1/service_server'),
        import('./server/xworld/seismology/v1/handler'),
        import('./src/generated/server/xworld/wildfire/v1/service_server'),
        import('./server/xworld/wildfire/v1/handler'),
        import('./src/generated/server/xworld/climate/v1/service_server'),
        import('./server/xworld/climate/v1/handler'),
        import('./src/generated/server/xworld/prediction/v1/service_server'),
        import('./server/xworld/prediction/v1/handler'),
        import('./src/generated/server/xworld/displacement/v1/service_server'),
        import('./server/xworld/displacement/v1/handler'),
        import('./src/generated/server/xworld/aviation/v1/service_server'),
        import('./server/xworld/aviation/v1/handler'),
        import('./src/generated/server/xworld/research/v1/service_server'),
        import('./server/xworld/research/v1/handler'),
        import('./src/generated/server/xworld/unrest/v1/service_server'),
        import('./server/xworld/unrest/v1/handler'),
        import('./src/generated/server/xworld/conflict/v1/service_server'),
        import('./server/xworld/conflict/v1/handler'),
        import('./src/generated/server/xworld/maritime/v1/service_server'),
        import('./server/xworld/maritime/v1/handler'),
        import('./src/generated/server/xworld/cyber/v1/service_server'),
        import('./server/xworld/cyber/v1/handler'),
        import('./src/generated/server/xworld/economic/v1/service_server'),
        import('./server/xworld/economic/v1/handler'),
        import('./src/generated/server/xworld/infrastructure/v1/service_server'),
        import('./server/xworld/infrastructure/v1/handler'),
        import('./src/generated/server/xworld/market/v1/service_server'),
        import('./server/xworld/market/v1/handler'),
        import('./src/generated/server/xworld/news/v1/service_server'),
        import('./server/xworld/news/v1/handler'),
        import('./src/generated/server/xworld/intelligence/v1/service_server'),
        import('./server/xworld/intelligence/v1/handler'),
        import('./src/generated/server/xworld/military/v1/service_server'),
        import('./server/xworld/military/v1/handler'),
        import('./src/generated/server/xworld/positive_events/v1/service_server'),
        import('./server/xworld/positive-events/v1/handler'),
        import('./src/generated/server/xworld/giving/v1/service_server'),
        import('./server/xworld/giving/v1/handler'),
        import('./src/generated/server/xworld/trade/v1/service_server'),
        import('./server/xworld/trade/v1/handler'),
        import('./src/generated/server/xworld/supply_chain/v1/service_server'),
        import('./server/xworld/supply-chain/v1/handler'),
        import('./src/generated/server/xworld/natural/v1/service_server'),
        import('./server/xworld/natural/v1/handler'),
        import('./src/generated/server/xworld/resilience/v1/service_server'),
        import('./server/xworld/resilience/v1/handler'),
      ]);
  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        '/widget-agent': {
          target: 'https://proxy.xworld.amirtech.ai',
          changeOrigin: true,
        },
        // Yahoo Finance API
        '/api/yahoo': {
