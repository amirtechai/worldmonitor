...
import dashboardFallback from './assets/xworld-7-mar-2026.jpg';
import wiredLogo from './assets/wired-logo.svg';

const API_BASE = 'https://xworld.amirtech.ai/api/api';
const TURNSTILE_SITE_KEY = '0x4AAAAAACnaYgHIyxclu8Tj';
const PRO_URL = 'https://xworld.amirtech.ai/pro';
...
const Logo = () => (
  <a href="https://xworld.amirtech.ai" className="flex items-center gap-2 hover:opacity-80 transition-opacity" aria-label="XWorld — Home">
    ...
    <div className="max-w-4xl mx-auto text-center relative z-10">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-4 mt-4">
          ...
          <a href="https://xworld.amirtech.ai" className="text-xs text-wm-green font-mono hover:text-green-300 transition-colors flex items-center gap-1">
      ...
      <div className="relative rounded-lg overflow-hidden border border-wm-border shadow-2xl shadow-wm-green/5">
        ...
        <div className="relative aspect-[16/9] bg-black">
          <img
            ...
            alt="XWorld Dashboard"
            className="absolute inset-0 w-full h-full object-cover"
          />
          <iframe
            src="https://xworld.amirtech.ai?alert=false"
          ...
          <div className="flex gap-4">
            ...
            <div>
              <div className="flex items-baseline gap-2 mb-1">
                <span className="font-bold text-gray-200">XWorld</span>
      ...
      <div className="order-2 lg:order-1">
        <div className="bg-black border border-wm-border rounded-lg overflow-hidden font-mono text-sm">
          <div className="bg-wm-card px-4 py-2 border-b border-wm-border flex items-center gap-2">
            ...
            <span className="text-wm-muted text-xs">api.xworld.amirtech.ai</span>
          </div>
          <div className="p-6 text-gray-300 overflow-x-auto">
            <pre><code>
<span className="text-wm-blue">curl</span> \<br/>
  <span className="text-wm-green">"https://xworld.amirtech.ai/api/v1/intelligence/convergence?region=MENA&time_window=6h"</span> \<br/>
  ...
  <footer className="border-t border-wm-border bg-[#020202] pt-24 pb-12 px-6 text-center" id="waitlist">
    ...
    <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto pt-8 border-t border-wm-border/50 text-xs text-wm-muted font-mono">
      ...
      <div className="flex items-center gap-6">
        ...
        <a href="https://xworld.amirtech.ai/blog/" className="hover:text-wm-text transition-colors">Blog</a>
        <a href="https://xworld.amirtech.ai/docs" className="hover:text-wm-text transition-colors">Docs</a>
        <a href="https://xworld.amirtech.ai" target="_blank" rel="noreferrer" className="hover:text-wm-text transition-colors">Status</a>
        <a href="https://github.com/koala73/xworld" target="_blank" rel="noreferrer" className="hover:text-wm-text transition-colors">GitHub</a>
        <a href="https://xworld.amirtech.ai" target="_blank" rel="noreferrer" className="hover:text-wm-text transition-colors">Discord</a>
        <a href="https://x.com/xworldai" target="_blank" rel="noreferrer" className="hover:text-wm-text transition-colors">X</a>
      </div>
      <span className="text-[10px] opacity-40 mt-4 md:mt-0">&copy; {new Date().getFullYear()} XWorld</span>
    </div>
  </footer>
);
...
export default function App() {
  ...
  useEffect(() => {
    initOverlay(() => {
      ...
      setTimeout(() => { window.location.href = 'https://xworld.amirtech.ai'; }, 3000);
    });
  }, []);
  ...
  return (
    <div className="min-h-screen selection:bg-wm-green/30 selection:text-wm-green">
      ...
      <main>
        ...
        {(localStorage.getItem('wm-widget-key') || localStorage.getItem('xw-pro-key')) && (
          <>
