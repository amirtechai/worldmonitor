...
const VARIANT_HOST_MAP: Record<string, string> = {
  'tech.xworld.amirtech.ai': 'tech',
  'finance.xworld.amirtech.ai': 'finance',
  'commodity.xworld.amirtech.ai': 'commodity',
  'happy.xworld.amirtech.ai': 'happy',
};
...
const VARIANT_OG: Record<string, { title: string; description: string; image: string; url: string }> = {
  tech: {
    ...
    image: 'https://xworld.amirtech.ai/technologyfavico/tech/og-image.png',
    url: 'https://xworld.amirtech.ai/technology',
  },
  finance: {
    title: 'Finance Monitor - Real-Time Markets & Trading Dashboard',
    description: 'Real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    image: 'https://xworld.amirtech.ai/financefavico/finance/og-image.png',
    url: 'https://xworld.amirtech.ai/finance',
  },
  commodity: {
    ...
    image: 'https://xworld.amirtech.ai/commodityfavico/commodity/og-image.png',
    url: 'https://xworld.amirtech.ai/commodity',
  },
  happy: {
    ...
    image: 'https://xworld.amirtech.aifavico/happy/og-image.png',
    url: 'https://xworld.amirtech.ai',
  },
};
