...
import { backtestStock } from '../server/xworld/market/v1/backtest-stock.ts';
import { listStoredStockBacktests } from '../server/xworld/market/v1/list-stored-stock-backtests.ts';
import { MarketServiceClient } from '../src/generated/client/xworld/market/v1/service_client.ts';
