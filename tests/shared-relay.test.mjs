...
function loadRelayFunctions() {
  ...
  const CHROME_UA = 'XWorld-Test-UA';
...
describe('getRelayHeaders — no auth', () => {
  ...
  it('aviation User-Agent override works', () => {
    const h = getRelayHeaders({ 'User-Agent': 'XWorld-Server/1.0' });
    assert.equal(h['User-Agent'], 'XWorld-Server/1.0');
  });
});
...
describe('relay.ts — consumer import verification', () => {
  const consumers = [
    { file: 'server/xworld/aviation/v1/_shared.ts', importPath: '../../../_shared/relay' },
    { file: 'server/xworld/intelligence/v1/_relay.ts', importPath: '../../../_shared/relay' },
    { file: 'server/xworld/research/v1/list-tech-events.ts', importPath: '../../../_shared/relay' },
    { file: 'server/xworld/maritime/v1/get-vessel-snapshot.ts', importPath: '../../../_shared/relay' },
    { file: 'server/xworld/market/v1/_shared.ts', importPath: '../../../_shared/relay' },
    { file: 'server/xworld/news/v1/list-feed-digest.ts', importPath: '../../../_shared/relay' },
    { file: 'server/xworld/military/v1/list-military-flights.ts', importPath: '../../../_shared/relay' },
  ];
  ...
  it('no local getRelayBaseUrl/getRelayHeaders/getRelayRequestHeaders definitions in server/ (except _shared/relay.ts)', () => {
    const dupeFiles = [
      'server/xworld/aviation/v1/_shared.ts',
      'server/xworld/intelligence/v1/_relay.ts',
      'server/xworld/research/v1/list-tech-events.ts',
      'server/xworld/maritime/v1/get-vessel-snapshot.ts',
      'server/xworld/market/v1/_shared.ts',
      'server/xworld/news/v1/list-feed-digest.ts',
      'server/xworld/military/v1/list-military-flights.ts',
    ];
  ...
  it('military list-military-flights.ts uses getRelayBaseUrl() not raw WS_RELAY_URL + /opensky', () => {
    const src = readFileSync(resolve('server/xworld/military/v1/list-military-flights.ts'), 'utf-8');
    assert.ok(
