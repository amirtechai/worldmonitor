...
- [ ] Nginx configuration (reference `deploy/nginx-xworld.conf`)
- [ ] SystemD service setup (reference `deploy/xworld-api.service`)
...
- [ ] Add entries for UI customizations on `feat/ui-customizations-xworld` branch
