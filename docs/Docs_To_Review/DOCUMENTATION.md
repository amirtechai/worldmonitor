...
🌐 **[Live Demo: xworld.amirtech.ai](https://xworld.amirtech.ai)** | 💻 **[Tech Variant: tech.xworld.amirtech.ai](https://xworld.amirtech.ai/technology)**
...
![XWorld Dashboard](images/new-world-monitor.png)

## Platform Variants

XWorld runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 XWorld** | [xworld.amirtech.ai](https://xworld.amirtech.ai) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.xworld.amirtech.ai](https://xworld.amirtech.ai/technology) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.xworld.amirtech.ai](https://xworld.amirtech.ai/technology)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that XWorld users may depend on.
...
// App.ts
const header = `XWorld v${__APP_VERSION__}`;
```
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between XWorld and Tech Monitor
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/xworld.git
   cd xworld
   ```
