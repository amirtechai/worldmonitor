...
XWorld runs five thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **XWorld** | xworld.amirtech.ai | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor** | tech.xworld.amirtech.ai | AI/ML, startups, cybersecurity, tech ecosystems |
| **Finance Monitor** | finance.xworld.amirtech.ai | Markets, central banks, Gulf FDI, commodities |
| **Commodity Monitor** | commodity.xworld.amirtech.ai | Mining, metals, energy, critical minerals |
| **Happy Monitor** | happy.xworld.amirtech.ai | Good news, conservation, positive global trends |

### AI Intelligence Layer

XWorld uses a multi-tier AI pipeline to process and summarize information:
...
XWorld aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
XWorld serves several audiences:
...
| Feature | XWorld | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
- **Web**: Available at xworld.amirtech.ai and variant subdomains
...
XWorld is actively developed with planned expansions across several areas:
...
- **API access** for developers and organizations to integrate XWorld data into their own tools
...
**Q: Where does XWorld get its data?**
...
**Q: Does XWorld track users or sell data?**
...
A: Yes. XWorld is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: XWorld was created by AmirTech. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed XWorld or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, an API tier is planned. Please attribute "XWorld (xworld.amirtech.ai)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. XWorld aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: XWorld is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/koala73/xworld
- **Website**: xworld.amirtech.ai

---

*This document was last updated March 2026. XWorld is an independent, open-source project licensed under AGPL-3.0.*
