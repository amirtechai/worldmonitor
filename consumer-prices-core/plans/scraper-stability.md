...
- src/snapshots/xworld.ts: retailer spread query — add AND pm.pin_disabled_at IS NULL
...
snapshots/xworld.ts buildRetailerSpreadSnapshot:
...
In xworld repo: src/services/consumer-prices/index.ts
...
21. Separate PR in xworld repo: remove ke from MARKETS (Task 11)
