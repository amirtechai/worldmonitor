...
export class PanelLayoutManager implements AppModule {
  ...
  private async fetchGitHubStars(): Promise<void> {
    try {
      const response = await fetch('https://api.github.com/repos/amirtechai/xworld');
    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">XWORLD</span><span class="logo-mobile">XWorld</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">XWORLD</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="https://amirtech.ai" target="_blank" rel="noopener" class="site-footer-credit site-footer-amirtech">AmirTech</a></span>
          </div>
        </div>
        <nav></nav>
