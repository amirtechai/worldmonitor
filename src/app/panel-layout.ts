...
export class PanelLayoutManager implements AppModule {
  ...
  constructor(ctx: AppContext, callbacks: PanelLayoutManagerCallbacks) {
    ...
    // premium via legacy signals (API key / xw-pro-key).
  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open('https://xworld.amirtech.ai/pro', '_blank');
      default:
        return () => {};
    }
  }
  ...
  private async fetchGitHubStars(): Promise<void> {
    try {
      const response = await fetch('https://api.github.com/repos/koala73/xworld');
  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://xworld.amirtech.ai')}"
            ...
            <a href="${vHref('tech', 'https://xworld.amirtech.ai/technology')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://xworld.amirtech.ai/finance')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://xworld.amirtech.ai/commodity')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://xworld.amirtech.ai')}"
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">XWorld</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@eliehabib</span>
          </a>
          <a href="https://github.com/koala73/xworld" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer-links">
          <a href="${this.ctx.isDesktopApp ? 'https://xworld.amirtech.ai/pro' : 'https://xworld.amirtech.ai/pro'}" target="_blank" rel="noopener">Pro</a>
          <a href="${this.ctx.isDesktopApp ? 'https://xworld.amirtech.ai/blog/' : 'https://xworld.amirtech.ai/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://xworld.amirtech.ai/docs' : 'https://xworld.amirtech.ai/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://xworld.amirtech.ai" target="_blank" rel="noopener">Status</a>
        </div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            ...
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="site-footer-credit">@eliehabib</a> &middot; <a href="https://world.amirtech.ai" target="_blank" rel="noopener" class="site-footer-credit site-footer-amirtech">AmirTech</a></span>
          </div>
        </div>
        <nav>
          <a href="${this.ctx.isDesktopApp ? 'https://xworld.amirtech.ai/pro' : 'https://xworld.amirtech.ai/pro'}" target="_blank" rel="noopener">Pro</a>
          ...
          <a href="${this.ctx.isDesktopApp ? 'https://xworld.amirtech.ai/docs' : 'https://xworld.amirtech.ai/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://xworld.amirtech.ai" target="_blank" rel="noopener">Status</a>
          <a href="https://github.com/amirtechai/xworld" target="_blank" rel="noopener">GitHub</a>
          <a href="https://xworld.amirtech.ai" target="_blank" rel="noopener">Discord</a>
          <a href="https://x.com/xworldai" target="_blank" rel="noopener">X</a>
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} XWorld &middot; Powered by <a href="https://amirtech.ai" target="_blank" rel="noopener" style="color:inherit;text-decoration:none;opacity:0.7;">AmirTech</a></span>
      </footer>
    `;
