...
import type { ListFeedDigestResponse } from '@/generated/client/xworld/news/v1/service_client';
import type { GetSectorSummaryResponse, ListMarketQuotesResponse, ListCommodityQuotesResponse } from '@/generated/client/xworld/market/v1/service_client';
import { mountCommunityWidget } from '@/components/CommunityWidget';
import { ResearchServiceClient } from '@/generated/client/xworld/research/v1/service_client';
import {
  MarketPanel,
  StockAnalysisPanel,
  StockBacktestPanel,
...
import type { NewsItem as ProtoNewsItem, ThreatLevel as ProtoThreatLevel } from '@/generated/client/xworld/news/v1/service_client';
...
export class DataLoaderManager implements AppModule {
  ...
  async loadForecasts(): Promise<void> {
    try {
      const hydrated = getHydratedData('forecasts') as { predictions?: import('@/generated/client/xworld/forecast/v1/service_client').Forecast[] } | undefined;
  ...
  async loadIntelligenceSignals(): Promise<void> {
    ...
    const hydratedUcdp = getHydratedData('ucdpEvents') as import('@/generated/client/xworld/conflict/v1/service_client').ListUcdpEventsResponse | undefined;
  ...
  async loadEconomicStress(): Promise<void> {
    try {
      ...
      const hydrated = getHydratedData('economicStress') as import('@/generated/client/xworld/economic/v1/service_client').GetEconomicStressResponse | undefined;
