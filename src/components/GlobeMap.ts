 ...
 *
 * Matches XWorld's MapContainer API so it can be used as a drop-in
...
import type { ImageryScene } from '@/generated/server/xworld/imagery/v1/service_server';
import { isAllowedPreviewUrl } from '@/utils/imagery-preview';
import { getCategoryStyle } from '@/services/webcams';
import { pinWebcam, isPinned } from '@/services/webcams/pinned-store';
import type { WebcamEntry, WebcamCluster } from '@/generated/client/xworld/webcam/v1/service_client';
import type { TrafficAnomaly as ProtoTrafficAnomaly, DdosLocationHit } from '@/generated/client/xworld/infrastructure/v1/service_client';
...
export class GlobeMap {
  ...
  private createLayerToggles(): void {
    ...
    const _wmKey = getSecretState('XWORLD_API_KEY').present;
    ...
    authorBadge.textContent = '© AmirTech · Someone™';
