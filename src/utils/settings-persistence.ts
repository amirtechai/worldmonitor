...
const SETTINGS_KEY_PREFIXES: readonly string[] = [
  ...
  'xworld-live-channels',
  'xworld-active-channel',
  'xworld-runtime-feature-toggles',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('xworld-variant') || 'full',
    data,
  };
  ...
  a.download = `xworld-settings-${ts}.json`;
