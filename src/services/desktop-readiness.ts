...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/xworld/conflict/v1/handler.ts', 'server/xworld/infrastructure/v1/handler.ts', 'server/xworld/cyber/v1/handler.ts', 'server/xworld/maritime/v1/handler.ts', 'server/xworld/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/xworld/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/xworld/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/xworld/military/v1/handler.ts'],
    locality: 'api-key',
