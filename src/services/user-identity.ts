 ...
 *   2. Legacy xw-pro-key from localStorage
 ...
 * in localStorage (`xw-anon-id`). This ID is lost if the user clears
...
const LEGACY_PRO_KEY = 'xw-pro-key';
const ANON_KEY = 'xw-anon-id';
