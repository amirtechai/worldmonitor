...
// VITE_VARIANT=tech → tech.xworld.amirtech.ai (tech-focused)
// VITE_VARIANT=full → xworld.amirtech.ai (geopolitical)
// VITE_VARIANT=finance → finance.xworld.amirtech.ai (markets/trading)
