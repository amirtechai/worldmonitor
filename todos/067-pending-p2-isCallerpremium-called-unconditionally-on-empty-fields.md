...
## Technical Details
- Files: `server/xworld/news/v1/summarize-article.ts:42`, `server/xworld/intelligence/v1/deduct-situation.ts:26`, `server/xworld/intelligence/v1/get-country-intel-brief.ts`
