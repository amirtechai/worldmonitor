...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://xworld.amirtech.ai');
  ...
  const baseUrl = 'https://xworld.amirtech.ai';
  ...
  const title = `${countryName} Intelligence Brief | XWorld`;
...
<head>
  ...
  <meta property="og:site_name" content="XWorld"/>

  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:site" content="@XWorldApp"/>
