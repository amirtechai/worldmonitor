...
import { assembleAnalystContext } from '../server/xworld/intelligence/v1/chat-analyst-context';
import { buildAnalystSystemPrompt } from '../server/xworld/intelligence/v1/chat-analyst-prompt';
import { buildActionEvents } from '../server/xworld/intelligence/v1/chat-analyst-actions';
  ...
  if (req.method === 'OPTIONS') {
    return new Response(null, {
      ...
      headers: {
        ...
        'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-XWorld-Key',
      },
    });
  }
