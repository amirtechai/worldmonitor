---
title: "Five Dashboards, One Platform: How XWorld Serves Every Intelligence Need"
description: "XWorld offers 5 free intelligence dashboards: geopolitical, tech, finance, commodity, and positive news. Switch between them instantly from one platform."
metaTitle: "5 Intelligence Dashboards, One Platform | XWorld"
...
heroImage: "/blog/images/blog/five-dashboards-one-platform-xworld-variants.jpg"
pubDate: "2026-02-12"
---
...
XWorld runs **five specialized dashboards** from a single codebase. Switch between them with one click. Each variant curates panels, layers, and data feeds for its specific audience while sharing the same underlying intelligence engine, map infrastructure, and AI capabilities.

## 1. XWorld: The Geopolitical Command Center

**URL:** xworld.amirtech.ai
**Panels:** 45
**Focus:** Conflicts, military, infrastructure, geopolitical risk

This is the flagship. XWorld is built for OSINT analysts, defense researchers, journalists, and anyone who needs to [understand global security dynamics](/blog/posts/track-global-conflicts-in-real-time/).
...
**URL:** finance.xworld.amirtech.ai
**Panels:** 27
...
**URL:** commodity.xworld.amirtech.ai
**Panels:** 16
...
- Integration with XWorld's conflict and disaster layers
...
The variants share a single codebase. Every improvement to the core engine benefits all five dashboards simultaneously. A map performance optimization for XWorld automatically makes Commodity Monitor faster too.
...
But when you need to cross domains (the commodity trader wants to check if a conflict is affecting mining operations), switching to XWorld is one click away.
...
- [xworld.amirtech.ai](https://xworld.amirtech.ai) for geopolitics
- [tech.xworld.amirtech.ai](https://xworld.amirtech.ai/technology) for technology
- [finance.xworld.amirtech.ai](https://xworld.amirtech.ai/finance) for markets
- [commodity.xworld.amirtech.ai](https://xworld.amirtech.ai/commodity) for commodities
- [happy.xworld.amirtech.ai](https://xworld.amirtech.ai) for good news
