 ...
 *
 * Requires: Referer header from trusted origin OR X-XWorld-Key header.
 * Uses api.xworld.amirtech.ai by default.
 */

const BASE_URL = process.argv.includes('--base-url')
  ? process.argv[process.argv.indexOf('--base-url') + 1]
  : 'https://xworld.amirtech.ai/api';

const ORIGIN = 'https://xworld.amirtech.ai';
...
const API_KEY = process.env.XWORLD_KEY || '';
