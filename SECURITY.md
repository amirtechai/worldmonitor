...
If you discover a security vulnerability in XWorld, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/koala73/xworld/security/advisories/new) to submit your report directly through the repository.
...
XWorld is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- XWorld aggregates publicly available OSINT data
...
- Vulnerabilities in the XWorld codebase
...
Thank you for helping keep XWorld and its users safe! 🔒
